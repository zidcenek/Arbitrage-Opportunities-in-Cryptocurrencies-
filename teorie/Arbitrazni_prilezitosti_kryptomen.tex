...
\begin{itemize}
    ...
    \item all\_count -- celé číslo, které udává kolik celkově proběhlo kontrol na výskyt arbitrážní příležitosti (neboli počet záznamů order book na třech příslušných měnových párech).
...
\begin{itemize}
    ...
    \item time\_delta -- zaznamenává detekovanou dobu výskytu arbitrážní příležitosti, 
...
\begin{itemize}
    ...
    \item jak dlouho průměrně trvají, jak velká pravděpodobnost na včasné vytěžení reálně existuje,
