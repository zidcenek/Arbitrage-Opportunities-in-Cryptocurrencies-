...
\paragraph{
Dalšími podpůrnými parametry pro výběr této burzy bylo to, že měla přívětivé api, a dalo se k ní připojit jednoduše přes websocket. \cite{BinanceApi}
}
