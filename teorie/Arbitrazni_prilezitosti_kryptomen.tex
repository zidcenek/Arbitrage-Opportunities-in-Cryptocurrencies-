...
The practical part follows up with a selection of the suitable cryptocurrency exchange. The problematic of data availability and its furhter processing is described in the next part. 
...
\begin{figure}
	\dirtree{%
		...
		.1 data\_collection\DTcomment{adresář se~spustitelnou formou sběru dat a manuálovou stránkou}.
		.1 data\_cleanup.\DTcomment{adresář se~spustitelnou formou čištění dat a manuálovou stránkou}.
